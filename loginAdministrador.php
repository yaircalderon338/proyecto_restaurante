...
<head>
    ...
    <title>Login de Anfitrión</title>
...
<body class="bg-dark">
    ...
    <div class="container">
        <div class="card card-login mx-auto mt-5">
            <div class="card-header">Login de Anfitrión</div>
            <div class="card-body">
                <form id="loginform">
    ...
    <script type="text/javascript">
        $('#loginform').submit(function() {
            $.ajax({
                type: "POST",
                url: 'process_anfitrion.php',  // Archivo de procesamiento
                data: {
                ...
                success: function(data) {
                    if (data === 'correct') {
                        window.location.replace('index_anfitrion.php');  // Página de destino
                    } else {
